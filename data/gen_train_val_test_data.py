...
full_dataset = pd.read_csv(config_dict['osteopenia_dataset_csv_path']).sample(frac=1) #shuffled dataset
...
x_train, X_test, y_train, Y_test = train_test_split(images, labels, test_size=1 - train_percentage) # split to get training

x_val, x_test, y_val, y_test = train_test_split(X_test, Y_test, test_size=(val_percentage*train_percentage)) # split to get val & test
